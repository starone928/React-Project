...
const NewsApp = () => {
    ...
    return (
        <>
        <h1 class="text-5xl text-lime-700 font-extrabold text-center tracking-widest hover:scale-90 "><span class="hover:bg-amber-400">WORLD NEWS</span></h1> <br/>
                    ...
                    data.map((item, i) => {
                        return (
                            <div class=" " key={i}>
                                ...
                                <div class="columns-1 max-w-sm  overflow-hidden  min-w-25 bg-lime-300 hover:scale-105 transition duration-1000 hover:bg-fuchsia-200  rounded-4xl border-t-4 border-t-green-500 shadow-2xl hover:shadow-pink-600 size-230 ">
                                    ...
                                    <div class="px-6 py-4">
                                        ...
                                        <p class="text-gray-700 text-base justify-center line-clamp-3">{item.description}</p>
                                    </div>
                                    ...
                                    <div class="m-2 p-2 ">
                                        <div class="text-2xl rounded-full bg-black text-white text-center">{item.country}</div> <br/>
                                        <div class="text-2xl rounded-full bg-black text-white text-center">{item.fetched_at}</div>
                                        ...
                                        <p class="line-clamp-3"><span class="text-orange-800 text-2xl font-bold">Id:-</span> {item.article_id}</p>
                                        <p class="font-bold line-clamp-3"><span class="text-orange-800 text-2xl font-bold" >Title:-</span>{item.title}</p>
                                    </div>
                                </div>
